...
module.exports = {
    getProduct: (search, sort, limit, offSide) => {
        return new Promise((resolve, reject) => {
            connection.query(`SELECT * FROM product WHERE ${search} LIKE '%coffe%' ORDER BY ${sort} LIMIT ? OFFSET ?`, [limit, offSide], (error, result) => {
